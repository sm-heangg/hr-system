...
<x-filament-panels::page>
    <div class="space-y-4">
        ...
        <div wire:ignore x-data="{ scanning: false, scannerInstance: null }" x-init="const onScanSuccess = (decodedText) => {
        ...
        scannerInstance.render(onScanSuccess, onScanError);">
            <div id="qr-reader" class="w-full max-w-md mx-auto border rounded-md shadow"></div>
        </div>
    </div>
